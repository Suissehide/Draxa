...
class EntretienController extends AbstractController
{
    ...
    public function entretien_add(Request $request) : Response
    {
        if ($request->isXmlHttpRequest()) {
            ...
            if ($em->getRepository(Entretien::class)->findSameDate($date[2], $date[1], $date[0], $patient_id) != [])
    ...
    public function entretien_patch(Request $request, Entretien $entretien) : Response
    {
        if ($request->isXmlHttpRequest()) {
            ...
            if ($entretien) {
                ...
                $patient_id = $request->request->get('patient');
                $t = $em->getRepository(Entretien::class)->findSameDate($date[2], $date[1], $date[0], $patient_id);
