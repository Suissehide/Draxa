...
class PatientFixtures extends Fixture
{
	public function load(ObjectManager $manager)
    {
        $patients = array(
            ...
            'patient2' => ['Observ2', 'Absence besoins éducatifs', 'DE', new \DateTime('2018-06-03'), 'Téo', 'Laulan', '05 86 86 93 48', '', 'homme', new \DateTime('1996-09-22'), 'Gironde', 'secondaire', 'Cadres et professions intellectuelles supérieures', 'retraité', 'AVC', new \DateTime('2018-08-02'), '', 'non', 'Absence de besoin', 'HRCV', ''],
            'patient3' => ['Observ3', 'Absence besoins éducatifs', 'M12', new \DateTime('2018-07-04'), 'Kevin', 'Bon', '06 87 12 23 29', ' 05 56 20 21 45', 'femme', new \DateTime('2001-05-03'), 'CUB', 'universitaire', 'Employés', 'retraité', 'CORONAROPATHIE', new \DateTime('2018-01-23'), '', 'oui', '', 'HRCV', ''],
            'patient4' => ['Observ4', 'Absence besoins éducatifs', 'DE', new \DateTime('2018-08-13'), 'Boris', 'Lomakin', '06 80 50 53 10', '', 'homme', new \DateTime('1999-11-16'), 'Hors Gironde', 'primaire', 'Artisans, commerçants et chefs d\'entreprises', 'actif', 'AVC', new \DateTime('2018-12-09'), '', 'non', 'Bon contrôle FDR', 'HRCV', ''],
        );
